...
public class TodoViewAsJava extends ConstraintLayout {
    private CheckBox completeCheckBox;
    private TextView descriptionView;
    public TodoViewAsJava(@NonNull Context context) {
        super(context);
    }

    public TodoViewAsJava(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TodoViewAsJava(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
